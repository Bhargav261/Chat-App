<template>
    <div class="md:w-3/5 w-full border-r-2 border-white">
        ...
        <div class="flex flex-col flex-auto flex-shrink-0 bg-gray-100 h-full" v-if="selctedUserID">
            <div class="relative flex justify-between items-center lg:space-x-4 md:space-x-4 space-x-0 p-4 bg-white">
                        ...
                        <div v-for="message in  messages " :key="message.timestamp" :class="{
                            ...
                            <div :class="{
                                ...
                                <div class="message-width" :class="{
                                    ...
                                    <div class="absolute text-xs bottom-0 -mb-5 ml-2 text-gray-500" :class="{
        ...
        <div class="flex flex-col flex-auto flex-shrink-0 bg-white-100 h-full height-message-block" v-if="!selctedUserID">
